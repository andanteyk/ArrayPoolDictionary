...
namespace ParallelDungeon.Rogue.Serialization
{
    ...
    public sealed class AnkerlDictionaryMod2<TKey, TValue> :
            ...
            where TKey : notnull
    {
        ...
        {
            private readonly AnkerlDictionaryMod2<TKey, TValue> m_Parent;

            internal KeyCollection(AnkerlDictionaryMod2<TKey, TValue> parent)
            {
                m_Parent = parent;
            }
            ...
            public struct Enumerator : IEnumerator<TKey>
            {
                ...
                internal Enumerator(AnkerlDictionaryMod2<TKey, TValue> parent)
                {
                    m_Parent = parent;
                    m_Index = -1;
                }
        ...
        public readonly struct ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            internal ValueCollection(AnkerlDictionaryMod2<TKey, TValue> parent)
            {
                m_Parent = parent;
            }
